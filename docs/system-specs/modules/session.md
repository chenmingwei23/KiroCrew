...
- **Consumers**: STRICT identity resolvers accept the direct
  ...
  `monitor_patrol`, `monitor_update`, `autonudge_stop`, `set_project` (plus
...
sequenceDiagram
    ...
    M->>T: call e.g. monitor_patrol(args)
