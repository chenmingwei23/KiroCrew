...
/** The filter model itself is pure (`./rosterFilter`); re-exported so the
 *  source-bucket helpers keep their public import path. */
export { parseSourceFilter, matchesSource, type MemberSourceFilter } from './rosterFilter'
...
const STATUS_LABEL_KEY: Record<MemberStatusFilter, string> = {
  working: 'pages.membersPage.filter_status_working',
  needs_you: 'pages.membersPage.filter_status_needs_you',
  unread: 'pages.membersPage.filter_status_unread',
...
const SORT_LABEL_KEY: Record<MemberSort, string> = {
  ...
  name: 'pages.membersPage.sort_name',
}
            ...
            <DropdownMenu open={filterMenuOpen} onOpenChange={setFilterMenuOpen}>
              <DropdownMenuTrigger asChild>
                <FilterMenuButton
                  ...
                  badge={filterCounts.status.needs_you}
