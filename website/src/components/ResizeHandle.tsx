 ...
 * all look and behave identically. Pair it with `useColumnResize` (or any
 * `usePointerDrag`) for `handleProps`, and `onNudge` for the arrow keys.
 *
...
export default function ResizeHandle({
  handleProps, label, onNudge, value, min, max, inset = 0, className, style,
}: {
