 ...
 * so they ride the static asset path and never enter a JS chunk.
 *
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent maxWidth={720} aria-describedby={descId}>
          ...
          {media && (
            <figure className="m-0">
              ...
              {/* Paging controls sit in the caption row, OUTSIDE the picture: an
                  ...
                  controls. */}
              <figcaption className="mt-1.5 flex items-center justify-between gap-3 text-[12px] text-muted">
        ...
        <DialogFooter className="justify-between">
          <span id={toggleLabelId} className="text-[13px] font-semibold text-text">
